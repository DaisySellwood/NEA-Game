 ...
 * @author daisy
 */
public class MageClassScreen extends javax.swing.JFrame {

    
    Toolkit tk = Toolkit.getDefaultToolkit();
    
    
    public MageClassScreen() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        BackButton.setBounds(29, 35, 220, 90);
        ...
        ChooseButton.setBounds(1549, 915, 330, 140);

        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUIs/Mage Class Screen.jpg"))); // NOI18N
    ...
    private void ChooseButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChooseButtonActionPerformed
        ...
        ClassSelectionScreen.CharacterClass = 1;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MageClassScreen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MageClassScreen().setVisible(true);
            }
        });
    }
